...
/**
 * TeamArrangeRestaurant entity for t_team_arrange_restaurant table.
 * 
 * 
 * @since 2014-02-17 17:24:43.558
 * @author smart-jdbc-tool
 */	
	
@Entity	
@Table(name = "t_team_arrange_restaurant")	
public class TeamArrangeRestaurant implements Serializable {	
	...
	@Column(name="cMealPeriod")
	private String cMealPeriod;
	
	@Column(name="cmealtype")
	private String cmealtype;
	
	@Column(name="cmealsummary")
	private String cmealsummary;
	...
	public void setCMealPeriod(String cMealPeriod){
	    this.cMealPeriod=cMealPeriod;
	}
	public String getCMealPeriod(){
	    return cMealPeriod;
	}
	public void setCmealtype(String cmealtype){
	    this.cmealtype=cmealtype;
	}
	public String getCmealtype(){
	    return cmealtype;
	}
	public void setCmealsummary(String cmealsummary){
	    this.cmealsummary=cmealsummary;
	}
	public String getCmealsummary(){
	    return cmealsummary;
	}
