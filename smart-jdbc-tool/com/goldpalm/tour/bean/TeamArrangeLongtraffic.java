...
/**
 * TeamArrangeLongtraffic entity for t_team_arrange_longtraffic table.
 * 
 * 
 * @since 2014-02-17 17:24:43.513
 * @author smart-jdbc-tool
 */	
	
@Entity	
@Table(name = "t_team_arrange_longtraffic")	
public class TeamArrangeLongtraffic implements Serializable {	
	...
	@Column(name="clongtrafficetype")
	private String clongtrafficetype;
	...
	private Date cboardtime;
	
	@Column(name="cofftime")
	private Date cofftime;
	
	@Column(name="cisarrive")
	private String cisarrive;
	...
	public void setClongtrafficetype(String clongtrafficetype){
	    this.clongtrafficetype=clongtrafficetype;
	}
	public String getClongtrafficetype(){
	    return clongtrafficetype;
	}
	...
	public void setCboardtime(Date cboardtime){
	    this.cboardtime=cboardtime;
	}
	public Date getCboardtime(){
	    return cboardtime;
	}
	public void setCofftime(Date cofftime){
	    this.cofftime=cofftime;
	}
	public Date getCofftime(){
	    return cofftime;
	}
	public void setCisarrive(String cisarrive){
	    this.cisarrive=cisarrive;
	}
	public String getCisarrive(){
	    return cisarrive;
	}
