...
/**
 * OrderGuest entity for t_order_guest table.
 * 
 * 
 * @since 2014-02-17 17:24:41.134
 * @author smart-jdbc-tool
 */	
	
@Entity	
@Table(name = "t_order_guest")	
public class OrderGuest implements Serializable {	
	...
	@Column(name="clycity")
	private String clycity;
	
	@Column(name="uorderlongtrafficbookid")
	private String uorderlongtrafficbookid;
	
	@Column(name="cbusplace")
	private String cbusplace;
	...
	public void setClycity(String clycity){
	    this.clycity=clycity;
	}
	public String getClycity(){
	    return clycity;
	}
	public void setUorderlongtrafficbookid(String uorderlongtrafficbookid){
	    this.uorderlongtrafficbookid=uorderlongtrafficbookid;
	}
	public String getUorderlongtrafficbookid(){
	    return uorderlongtrafficbookid;
	}
	public void setCbusplace(String cbusplace){
	    this.cbusplace=cbusplace;
	}
	public String getCbusplace(){
	    return cbusplace;
	}
