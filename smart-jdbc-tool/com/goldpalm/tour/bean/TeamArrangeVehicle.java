...
/**
 * TeamArrangeVehicle entity for t_team_arrange_vehicle table.
 * 
 * 
 * @since 2014-02-17 17:24:43.656
 * @author smart-jdbc-tool
 */	
	
@Entity	
@Table(name = "t_team_arrange_vehicle")	
public class TeamArrangeVehicle implements Serializable {	
	...
	@Column(name="cvehiclesummary")
	private String cvehiclesummary;
	
	@Column(name="ivehicleqty")
	private Integer ivehicleqty;
	...
	public void setCvehiclesummary(String cvehiclesummary){
	    this.cvehiclesummary=cvehiclesummary;
	}
	public String getCvehiclesummary(){
	    return cvehiclesummary;
	}
	public void setIvehicleqty(Integer ivehicleqty){
	    this.ivehicleqty=ivehicleqty;
	}
	public Integer getIvehicleqty(){
	    return ivehicleqty;
	}
