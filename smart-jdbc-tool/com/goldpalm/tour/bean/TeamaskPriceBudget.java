...
/**
 * TeamaskPriceBudget entity for t_teamask_price_budget table.
 * 
 * 
 * @since 2014-02-17 17:24:44.241
 * @author smart-jdbc-tool
 */	
	
@Entity	
@Table(name = "t_teamask_price_budget")	
public class TeamaskPriceBudget implements Serializable {	
	...
	@Column(name="uteamaskpriceid")
	private String uteamaskpriceid;
	...
	@Column(name="npriceamount")
	private Double npriceamount;
	...
	public void setUteamaskpriceid(String uteamaskpriceid){
	    this.uteamaskpriceid=uteamaskpriceid;
	}
	public String getUteamaskpriceid(){
	    return uteamaskpriceid;
	}
	...
	public void setNpriceamount(Double npriceamount){
	    this.npriceamount=npriceamount;
	}
	public Double getNpriceamount(){
	    return npriceamount;
	}
}